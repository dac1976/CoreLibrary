...
OUTPUT_DIR="RelWithDebInfo/static"

# Create build files
cmake -Bbuild  -DCMAKE_INSTALL_PREFIX="${OUTPUT_DIR}"  -DBUILD_SHARED_LIBS=OFF  -DCORELIB_USE_STD_FILESYSTEM=ON  -DCMAKE_BUILD_TYPE=RelWithDebInfo
