...
export CORELIB_PROTOBUF_LIB=%CORELIB_ROOT%../../../ThirdParty/grpc/grpc_gcc11.4_v1.78.1/cmake/build/third_party/protobuf/Release
...
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release -DCORELIB_USE_STD_FILESYSTEM=ON -DCORELIB_DISABLE_ASIO_TESTS=OFF -DCORELIB_DISABLE_CSVGRID_TESTS=OFF -DCORELIB_DISABLE_DEBUGLOG_TESTS=OFF -DCORELIB_DISABLE_FILEUTILS_TESTS=OFF -DCORELIB_DISABLE_FLOAT_COMPARE_TESTS=OFF -DCORELIB_DISABLE_SORTING_TESTS=OFF -DCORELIB_DISABLE_GPROTOBUF_TESTS=OFF -DCORELIB_DISABLE_INIFILE_TESTS=OFF -DCORELIB_DISABLE_SERIALIZATION_TESTS=OFF -DCORELIB_DISABLE_STRINGUTILS_TESTS=OFF 
