...
#define LOKI_ENABLE_NEW_SETLONGLIVITY_HELPER_DATA_IMPL        
        ...
        Destroyer d)
    {
		...
		// (HGL) - Changed from auto_ptr to unique_ptr.
...
#pragma warning( pop )
    ...
    template <class T>
    atexit_pfn_t DeletableSingleton<T>::deleter = nullptr;
    ...
    FollowIntoDeath::Followers<T>::followers_ = nullptr;
    ...
    typename SingletonHolder<T, C, L, M, X>::PtrInstanceType
        SingletonHolder<T, C, L, M, X>::pInstance_ = nullptr;
