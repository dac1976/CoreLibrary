...
private:
    ...
    /*! \brief Default message size of async send message pool. */
    size_t m_sendPoolMsgSize{0};
    /*! \brief Default message size of receive message pool. */
    size_t m_recvPoolMsgSize{defs::RECV_POOL_DEFAULT_MSG_SIZE};
